...
public class ConsultasFacturas extends javax.swing.JInternalFrame {
    ...
    void cargartodasfacturas() {
        ...
        String[] titulos = {"NUMERO", "COD. CLIENTE", "SUBTOTAL", "IMPUESTO", "TOTAL", "FECHA"};
        tabla.setColumnIdentifiers(titulos);
        this.tbfacturas.setModel(tabla);
        String consulta = "SELECT * FROM restaurante.factura";
        ...
        try {
            ...
            Logger.getLogger(ConsultasPlatillos.class.getName()).log(Level.SEVERE, null, ex);
        }
...
// TODO add your handling code here:
    ...
    if (rdbnnumero.isSelected() == true) {
        consulta = "SELECT * FROM restaurante.factura WHERE num_fac='" + num + "'";
    }
    if (rdbbnfecha.isSelected() == true) {
        Date fecha = jDateChooser1.getDate();
        SimpleDateFormat formatofecha = new SimpleDateFormat("dd/MM/YYYY");
        String fec = "" + formatofecha.format(fecha);
        consulta = "SELECT * FROM restaurante.factura WHERE fec_fac='" + fec + "'";
    }
    if (rdbntodos.isSelected() == true) {
        consulta = "SELECT * FROM restaurante.factura ";
    }
    DefaultTableModel tabla = new DefaultTableModel();
    String[] titulos = {"NUMERO", "COD. CLIENTE", "SUBTOTAL", "IMPUESTO", "TOTAL", "FECHA"};
    tabla.setColumnIdentifiers(titulos);
...
// TODO add your handling code here:
    ...
    if (filasele == -1) {
        ...
        String ver = "SELECT * FROM restaurante.detallefactura WHERE num_fac='" + numfac + "'";
...
// TODO add your handling code here:
    ...
    if (fila >= 0) {
        ...
        try {
            PreparedStatement pst = cn.prepareStatement("DELETE FROM restaurante.factura WHERE num_fac='" + cod + "'");
            pst.executeUpdate();
        } catch (SQLException ex) {
