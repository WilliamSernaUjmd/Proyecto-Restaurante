 ...
 */
public class Tiket extends javax.swing.JInternalFrame {
    ...
    void numeros() {
        ...
        String num = "";
        String c = "";
        String SQL = "select max(num_tik) * FROM restaurante.tiket";
        try {
    ...
    void Tiket() {
        String InsertarSQL = "INSERT INTO restaurante.tiket(num_Tik,cod_cli,pre_tot,fecha) VALUES (?,?,?,?)";
    ...
    void detalleTiket() {
        for (int i = 0; i < tbdetbol.getRowCount(); i++) {
            String InsertarSQL = "INSERT INTO restaurante.detalletiket(num_tick,cod_pla,des_pla,cant_pla,precio,pre_venta) VALUES (?,?,?,?,?,?)";
            String num_tick = txtnumbol.getText();
            String cod_pla = tbdetbol.getValueAt(i, 0).toString();
            String des_pla = tbdetbol.getValueAt(i, 1).toString();
            String cant_pla = tbdetbol.getValueAt(i, 3).toString();
            String precio = tbdetbol.getValueAt(i, 2).toString();
            String pre_venta = tbdetbol.getValueAt(i, 4).toString();

            try {
                PreparedStatement pst = cn.prepareStatement(InsertarSQL);
                pst.setString(1, num_tick);
                pst.setString(2, cod_pla);
                pst.setString(3, des_pla);
                pst.setString(4, cant_pla);
                pst.setString(5, precio);
                pst.setString(6, pre_venta);
    ...
    private void initComponents() {
        ...
        jLabel6.setText("       Tiket de Venta");
        ...
        btnplatillos.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/buscar1.JPG"))); // NOI18N
        btnplatillos.setText("BUSCAR");
        ...
        jLabel1.setText("Restaurante xyz");
        ...
        getAccessibleContext().setAccessibleName("Tiket");
...
// TODO add your handling code here:
    if (tbdetbol.getRowCount() < 1) {
        JOptionPane.showMessageDialog(this, "ingrese algun platillo");
    } else {
        calcular();
    }
...
// TODO add your handling code here:
    if ((txtcod.getText().equals("")) || (txttotal.getText().equals(""))) {
        JOptionPane.showMessageDialog(this, "Ingrese cliente, platillo o realice operacion");
    } else {
        String capcod = "", capcan = "";
        for (int i = 0; i < Tiket.tbdetbol.getRowCount(); i++) {
            capcod = Tiket.tbdetbol.getValueAt(i, 0).toString();
            capcan = Tiket.tbdetbol.getValueAt(i, 3).toString();
