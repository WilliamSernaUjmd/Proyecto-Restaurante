...
public class ClientesB extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor) {
        ...
        String Sql = "SELECT * FROM restaurante.cliente WHERE CONCAT(cod_cli,nom_cli,ape_cli,dni_cli) LIKE '%" + valor + "%'";
...
// TODO add your handling code here:
    ...
    try {
        if (fila == -1) {
            ...
            Tiket.txtcod.setText(cod);
            Tiket.txtnomape.setText(nom + "   " + ape);
            Tiket.txtdire.setText(dir);
            Tiket.txtdni.setText(dni);
