 ...
 */
public class ConsultasPlatillos extends javax.swing.JInternalFrame {

    /** Creates new form ConsultasProductos */
    public ConsultasPlatillos() {
        initComponents();
        mostrartodosPlatillos();
    }
    void mostrartodosPlatillos()
    {
        DefaultTableModel tabla= new DefaultTableModel();
        String []titulos={"CODIGO","DESCRIPCION","PRECIO"};
        tabla.setColumnIdentifiers(titulos);
        this.tbproductos.setModel(tabla);
        String consulta= "SELECT * FROM restaurante.platillo";
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("CONSULTA DE PLATILLOS");

        buttonGroup1.add(rbtndes);
        rbtndes.setSelected(true);
        rbtndes.setText("Mostrar Platillos por Descripcion");
        ...
        rbtntodo.setText("Mostrar todos los Platillos");
        ...
        rbtndes.getAccessibleContext().setAccessibleName("Mostrar Platillos por Descripcion");
...
// TODO add your handling code here:
    ...
    if(rbtndes.isSelected()==true)
    {
        ...
        tabla.setColumnIdentifiers(titulos);
        this.tbproductos.setModel(tabla);
        String consulta= "SELECT * FROM restaurante.platillo WHERE descripcion  LIKE '%"+buscar+"%'";
        String []Datos= new String [3];
        try {
            Statement st = cn.createStatement();
            ResultSet rs= st.executeQuery(consulta);
