 ...
 */
public class IngresoPlatillos extends javax.swing.JInternalFrame {
    ...
    void cargar(String valor) {
        try {
            ...
            String cons = "select * FROM restaurante.platillo WHERE CONCAT (descripcion,'',precio) LIKE '%" + valor + "%'";
    ...
    void BuscarProductoEditar(String cod) {
        ...
        try {
            ...
            String cons = "select * FROM restaurante.platillo WHERE cod_pro='" + cod + "'";
            Statement st = cn.createStatement();
            ResultSet rs = st.executeQuery(cons);
            while (rs.next()) {
                codi = rs.getString(1);
    ...
    void codigos() {
        ...
        String num = "";
        String c = "";
        String SQL = "select max(cod_pro) FROM restaurante.platillo";
        try {
            Statement st = cn.createStatement();
...
// TODO add your handling code here:
    ...
    try {
        if (filasel == -1) {
            ...
            String eliminarSQL = "DELETE FROM restaurante.platillo WHERE cod_pla = '" + cod + "'";
            try {
...
// TODO add your handling code here:
    ...
    des = txtdes.getText();
    pre = txtpre.getText();
    sql = "INSERT INTO restaurante.platillo (cod_pla,descripcion,precio) VALUES (?,?,?)";
    try {
...
// TODO add your handling code here:
    String sql = "UPDATE restaurante.platillo SET precio = '" + txtpre.getText() + "',descripcion ='" + txtdes.getText();
    try {
        PreparedStatement pst = cn.prepareStatement(sql);
        pst.executeUpdate();
